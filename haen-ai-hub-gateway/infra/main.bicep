...
// HAEN (Humanitarian AI Emergency Network) AI Hub Gateway
// This template deploys all the resources needed for the HAEN AI Hub Gateway
// which provides centralized AI services for all HAEN agents and components
...
// HAEN OpenAI Instances Configuration
// These instances are used by various HAEN agents including:
...
param openAiInstances object = {
  openAi1: {
    ...
    deployments: [
      ...
      // HAEN-specific model deployment for humanitarian response
      {
        name: 'haen-response'
        model: {
          format: 'OpenAI'
        ...
        sku: {
          name: 'Standard'
          capacity: deploymentCapacity * 2  // Double capacity for emergency response scenarios
        }
      }
    ]
  }
  openAi2: {
    ...
    deployments: [
      ...
      // HAEN-specific model deployment for backup region
      {
        name: 'haen-response'
        model: {
          format: 'OpenAI'
